<!-- src/components/05110_Membership/Page/purchaseMemLight.vue -->
<template>
  <ion-page class="purchase-detail">
    <ion-header translucent="true">
      <ion-toolbar>
        <ion-title>구독 라이트회원</ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content :fullscreen="true">
      <section class="hero">
        <h2>라이트 멤버십 (월)</h2>
        <p>가격은 부가세 포함 총액 기준입니다.</p>
      </section>

      <ion-card class="option">
        <ion-card-header>
          <ion-card-title>라이트 회원 구독 (월)</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          ...
          <ion-button expand="block" class="btn-gold" @click="subscribe">구독하기</ion-button>
        </ion-card-content>
      </ion-card>
...
function subscribe () {
  // TODO: 구독 결제(정기결제) 연동
  console.log('subscribe: light', { total, supply, vat })
}
</script>
...
.split { margin: 8px 0 12px; padding-left: 18px; line-height: 1.6; }
.benefits { margin: 0 0 16px; padding-left: 18px; line-height: 1.6; }
