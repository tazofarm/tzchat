...
/** ✅ 현재 로그인한 '뷰어'의 등급/프리미엄회원 여부 (노출 판단은 항상 뷰어 기준) */
const viewerLevel = ref<string>('') // '일반회원' | '라이트회원' | '프리미엄회원' 등
...
/** ✅ 현재 로그인한 내 등급/프리미엄회원 여부를 서버에서 가져와서 설정 (노출 판단용) */
...
.chat-button { display:flex; justify-content:flex-end; }
.chat-button ion-button {width : 65%; --padding-top: 2px; --padding-bottom: 2px; font-size: 12px; min-height: 28px; }
...
.button-group ion-button {
  ...
  font-size: 10px; --border-radius: 8px; min-height: 28px;
  white-space: nowrap;
}
